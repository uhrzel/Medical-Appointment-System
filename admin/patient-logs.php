    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-dashbord">
                        <a href="doctor-logs.php" class="non-style-link-menu">
                            <p class="menu-text">Doctor Logs</p>
                        </a>
                    </td>
                </tr>
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active">
                        <a href="patient-logs.php" class="non-style-link-menu non-style-link-menu-active">
                            <p class="menu-text">Patient Logs</p>
                        </a>
                    </td>
                </tr>
                            ...
                            <div class="abc scroll">
                                <table width="93%" class="sub-table scrolldown" border="0">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM patient_logs ORDER BY id DESC";
